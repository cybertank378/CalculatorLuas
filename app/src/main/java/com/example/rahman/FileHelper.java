...
/**
 * Created              : Rahman on 5/3/2017.
 * Date Created         : 5/3/2017 / 4:12 AM.
 * ===================================================
 * Package              : com.example.rahman.
 * Project Name         : CalculatorLuas2.
 * Copyright            : Copyright @ 2017 Olmatix.
 */
public class FileHelper {
    private final static String TAG = FileHelper.class.getName();
    private final static String DIRECTORY = "/CalcDir";
    private final static String FILE_NAME = "fileData.txt";
